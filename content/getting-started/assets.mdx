  ...
  <FileTree.Folder name="resources" defaultOpen>
      <FileTree.Folder name="assets" defaultOpen>
        ...
        <FileTree.Folder name="js" defaultOpen>
            ...
            <FileTree.File name={<FileTreeLabel type="file" name="my-react-component.jsx">React</FileTreeLabel>} />
        </FileTree.Folder>
      </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
<FileTree>
  <FileTree.Folder name="public" defaultOpen>
      ...
      <FileTree.Folder name="js" defaultOpen>
          ...
          <FileTree.File name={<FileTreeLabel type="file" name="my-react-component.js">React</FileTreeLabel>} />
      </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
If you need to create more complex ReactJS components or applications, check out the [ReactJS Components](/docs/views-template/react) section and the [ReactJS Applications](/docs/views-template/react-app) section.
