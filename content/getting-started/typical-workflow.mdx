...
Of course, you can start to work on styles and JavaScript by using the watcher provided by the package.json file.
...
<Callout type="info">
Take a look at how [plugin versioning works](/docs/bones-console/bones-console#version)
</Callout>
