...
We are considering the possibility of turning this feature into an __📦 external package__. If you would like to join the discussion, [jump in here](https://github.com/orgs/wpbones/discussions/57).
</Callout>
...
Of course, there are some attributes with a dash character like `accept-charset`. In this case, you have to use a camel case version of attributes to set it fluently:
