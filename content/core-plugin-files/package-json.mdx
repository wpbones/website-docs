...
| `yarn format` | Prettier over the plugin's JS, TS, JSON and YAML, except what `.prettierignore` lists (`public/`, `vendor/`, Composer's files) |
...
`gulpfile.js`, run the automated migrator: [`php bones migrate:to-v2`](/docs/bones-console/bones-console).
