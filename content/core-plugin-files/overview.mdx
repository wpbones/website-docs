...
Under the hood, the bones command runs `composer update wpbones/wpbones --with-dependencies`, and Composer renames the new framework into your namespace when it is done.
...
<FileTree>
  <FileTree.Folder name="myPlugin" defaultOpen>
    ...
    <FileTree.File name={<FileTreeLabel type="file" href="./package-json" name="package.json">used by yarn</FileTreeLabel>} />
    <FileTree.File name={<FileTreeLabel type="file" href="./webpack-config" name="webpack.config.js">auto-discovery webpack config</FileTreeLabel>} />
  </FileTree.Folder>
</FileTree>