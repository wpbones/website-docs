...
<FileTree>
  <FileTree.Folder name="myPlugin" defaultOpen>
    <FileTree.Folder
      name={
        <FileTreeLabel name="bootstrap" color="yellow">
          bootstrapping framework and autoloading
        </FileTreeLabel>
      }
    />
    <FileTree.Folder
      name={
        <FileTreeLabel name="config">
          contains all of your configuration plugin's files
        </FileTreeLabel>
      }
    />
    <FileTree.Folder
      name={
        <FileTreeLabel name="database">
          contains your database migration
        </FileTreeLabel>
      }
    />
    <FileTree.Folder
      name={
        <FileTreeLabel name="languages">
          contains the `.mo` and `.pot` to localize your plugin
        </FileTreeLabel>
      }
    />
    <FileTree.Folder
      name={
        <FileTreeLabel name="plugin">
          contains the core code of your plugin
        </FileTreeLabel>
      }
    />
    <FileTree.Folder
      name={
        <FileTreeLabel name="public">
    ...
    <FileTree.Folder
      name={
        <FileTreeLabel name="resources">
          contains your views, raw assets
        </FileTreeLabel>
      }
    />
    <FileTree.Folder
      name={
        <FileTreeLabel name="vendor" color="red">
          contains (at this moment) the WP Bones Framework
        </FileTreeLabel>
      }
    />
  </FileTree.Folder>
...
<FileTree>
  <FileTree.Folder name="myPlugin" defaultOpen>
    <FileTree.Folder
      name={
        <FileTreeLabel name="api">
          contains your REST API endpoints
        </FileTreeLabel>
      }
    />
    <FileTree.Folder
      name={
        <FileTreeLabel name="pages">
          contains your plugin's custom page
        </FileTreeLabel>
      }
    />
  </FileTree.Folder>
...
<Callout type="info">
  Check out [REST API](/docs/services-provider/rest-api) and [custom
  pages](pages-routing#custom-admin-pages-folder) for more
  information.
</Callout>
...
<FileTree>
  <FileTree.Folder name="myPlugin" defaultOpen>
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="bones" color="orange">
    ...
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="composer.lock" color="red">
          used by composer
        </FileTreeLabel>
      }
    />
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="webpack.config.js">
          webpack config with auto-discovered entries
        </FileTreeLabel>
      }
    />
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="tsconfig.json">
          TypeScript config
        </FileTreeLabel>
      }
    />
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="jest.config.js">
          Jest config (WP preset)
        </FileTreeLabel>
      }
    />
    <FileTree.File
      name={
        <FileTreeLabel type="file" name=".prettierrc">
          Prettier config
        </FileTreeLabel>
      }
    />
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="{your-plugin-name}.php">
    ...
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="namespace" color="red">
    ...
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="package.json">
          used by yarn
        </FileTreeLabel>
      }
    />
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="readme.txt">
...
<FileTree>
  <FileTree.Folder name="my_plugin" defaultOpen>
    <FileTree.Folder name="plugin" defaultOpen>
      ...
      <FileTree.Folder
        name={
          <FileTreeLabel name="hooks" color="yellow">
            available as optional starting v1.8
          </FileTreeLabel>
        }
      />
      <FileTree.Folder
        name={
          <FileTreeLabel name="modules" color="yellow">
            available as optional starting v1.8
          </FileTreeLabel>
        }
      />
...
<Cards num={1}>
  <Cards.Card
    arrow
    title="Learn more about the Plugin class"
    href="/docs/core-classes/plugin"
  />
</Cards>
