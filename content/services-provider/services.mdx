...
This document explains the Services Provider in WP Bones. It covers various WordPress services like Ajax, Shortcodes, Custom Post Types, and more, managed by the `config/plugin.php` file. It lists available services and provides steps to create your own service provider using the `php bones make:provider MyProvider` command. The new provider will be created in the `plugins/Providers` directory, and you can edit the service provider bootstrap to register your custom services.
...
- [Ajax](/docs/services-provider/ajax)
- [Custom Post Types](/docs/services-provider/custom-post-types)
- [Custom Taxonomies](/docs/services-provider/custom-post-types)
- <AnimateBadge /> [Custom Schedule](/docs/services-provider/schedule)
- [Custom Shortcodes](/docs/services-provider/shortcodes)
