...
You can customize the deployment process by using the action `wpbones_console_deployed`. This is very useful, for example, to delete a folder and write a new file. To do that, you can override the `__construct` method in your command.
