...
<FileTree>
  <FileTree.Folder name="myPlugin" defaultOpen>
    ...
    <FileTree.Folder label={<FileTreeLabel name="languages">contains the `.mo` and `.pot` to localize your plugin</FileTreeLabel>} />
...
<FileTree>
  <FileTree.Folder name="my_plugin" defaultOpen>
    <FileTree.Folder name="plugin" defaultOpen>
      ...
      <FileTree.Folder label={<FileTreeLabel name="hooks" color="yellow">available as optional starting v1.8</FileTreeLabel>} />
      <FileTree.Folder label={<FileTreeLabel name="modules" color="yellow">available as optional starting v1.8</FileTreeLabel>} />
