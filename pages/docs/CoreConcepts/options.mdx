...
<Cards num={1}>
  <Card icon={<IconBrandWordpress color="#74C0FC" />} title="Demo Plugin in action" target="_blank" href="https://playground.wordpress.net/?blueprint-url=https://wpbones.vercel.app/wpkirk-demo.json" />
</Cards>