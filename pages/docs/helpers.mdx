...
These helper functions may become a problem when different versions of the framework will load in WordPress. In fact, a function has not a namespace like a class. Anyway, in this release, I'm taking care to limit these functions.
</Callout>
