...
Discussion regarding bugs, new features, ideas 💡, and implementation of existing features takes place in the issue GitHub channel. If you like, you may connect to the [Slack](https://wpbones.slack.com/) channel as well.
