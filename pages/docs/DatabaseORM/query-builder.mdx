...
<Cards num={1}>
<Cards.Card arrow icon={<IconBrandGithub color="white" />} title={<Group><AnimateBadge />WP Bones Database Boilerplate</Group>} target="_blank" href="https://github.com/new?template_name=WPKirk-API-Boilerplate&template_owner=wpbones"/>
</Cards>