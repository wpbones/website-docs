...
You may protect your Ajax calls by using two main methods: bye the simple capability property or by the nonce key.
...
Next, you have to generate the nonce in your Controller and make it available to the Javascript side. You can use `withLocalizeScripts` method to pass the nonce to the Javascript side.
...
class DashboardController extends Controller
{
  public function index()
  {
    return WPKirk()
      ...
      ->withLocalizeScripts("app", "WPKirkNonce", [
