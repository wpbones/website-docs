...
Next, you have to generate the nonce in your Controller and make it available to the JavaScript side. You can use the `withLocalizeScripts` method to pass the nonce to the JavaScript side.
