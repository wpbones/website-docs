...
## Schedule Boilerplate

<Cards num={1}>
<Cards.Card arrow icon={<IconBrandGithub />} title={<Group>Cron Schedule</Group>} target="_blank" href="https://github.com/new?template_name=WPKirk-Cron-Boilerplate&template_owner=wpbones"/>
</Cards>
