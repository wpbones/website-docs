...
<Card arrow icon={<IconBrandGithub color="white" />} title={<Group><AnimateBadge />WP Bones API Boilerplate</Group>} target="_blank" href="https://github.com/new?template_name=WPKirk-API-Boilerplate&template_owner=wpbones"/>

<Card arrow icon={<IconBrandWordpress />} title="WordPress Developer API Documentation" target="_blank" href="https://developer.wordpress.org/rest-api/extending-the-rest-api/"/>
