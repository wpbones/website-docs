...
<Cards num="1">
  <Card icon={<IconBrandWordpress />} title="See it in action in your browser" target="_blank" href="https://playground.wordpress.net/?blueprint-url=https://wpbones.com/wpkirk-demo.json" />
</Cards>  
