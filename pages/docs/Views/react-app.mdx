...
<Cards num={2}>
<Card arrow icon={<IconBrandGithub />} title={<Group><AnimateBadge />Mantine UI Boilerplate</Group>} target="_blank" href="https://github.com/new?template_name=WPKirk-Mantine-Boilerplate&template_owner=wpbones"/>
<Card arrow icon={<IconBrandGithub />} title={<Group><AnimateBadge />ReactJS Boilerplate</Group>} target="_blank" href="https://github.com/new?template_name=WPKirk-Reactjs-Boilerplate&template_owner=wpbones"/>
</Cards>
...
<Cards num="1">
  <Card icon={<IconBrandWordpress />} title="See it in action in your browser" target="_blank" href="https://playground.wordpress.net/?blueprint-url=https://wpbones.vercel.app/wpkirk-demo.json" />
</Cards>  
