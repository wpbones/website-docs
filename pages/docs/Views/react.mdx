...
<Card arrow icon={<IconBrandGithub />} title={<Group><AnimateBadge />Try the WP Bones ReactJS Boilerplate</Group>} target="_blank" href="https://github.com/new?template_name=WPKirk-Reactjs-Boilerplate&template_owner=wpbones"/>
