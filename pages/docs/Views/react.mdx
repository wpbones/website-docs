import { ActionButton, AnimateBadge, Boilerplate, BoilerplateDemoButton, FileTreeLabel } from "@components";
...
<BoilerplateDemoButton slug="reactjs" />
...
<Boilerplate column={1} display={['react']} title={{
  react: 'Try the WP Bones ReactJS Boilerplate',
}} />
