...
Also, you can enqueue scripts and styles just in the theme, for example when you will display a view for a widget. In this case, you can use [`withStyle()`](/docs/CoreClasses/view#withstyles) and [`withScript()`](/docs/CoreClasses/view#withscript) fluent methods. All these methods accept three parameters: name, dependencies, and version:
