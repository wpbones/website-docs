...
> :pushpin:
>
> **Note**: Remember that a plugin name is bound to PHP namespace. This because WordPress doesn't support namespace in current plugin architecture.
...
> NOTE: Probably, you won't need to that as the update flow is already in the composer file
